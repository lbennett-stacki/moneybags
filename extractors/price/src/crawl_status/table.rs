...
#[derive(Debug)]
pub struct CrawlStatusRowIdentifier {
    pub account_address: String,
    pub transaction_signature: String,
}
...
pub enum CrawlStatusOperation {
    ...
    MarkAsSucceeded(CrawlStatusRowIdentifier),
    MarkAsFailed(CrawlStatusRowIdentifier, String),
    MarkAsFirstAccountSignature(CrawlStatusRowIdentifier),
}
